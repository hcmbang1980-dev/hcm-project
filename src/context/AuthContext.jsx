...
export function AuthProvider({ children }) {
  ...
  // 텔레그램 위젯 또는 봇 인증 처리
  // tgUser: 위젯에서 오는 rawData, directUser: 봇 인증으로 이미 완성된 user 객체
  const handleTelegramLogin = async (tgUser, directUser) => {
    try {
      ...
      if (directUser) {
        ...
        logToSheet(directUser, null, ip, navigator.userAgent, false)
        return
      }
