        ...
        <header className="header">
              <div className="header-inner">
                      ...
                      <nav className="nav-desktop">
                                ...
                                <div className="nav-dropdown">
                                            ...
                                            <div className="dropdown-menu">
                                                          <Link to="/places/karaoke-korean">한 가라오케&바</Link>Link>
                                                          <Link to="/places/karaoke-local">로컬 가라오케&바</Link>Link>
                                                          <Link to="/places/massage">건전마사지</Link>Link>
                                                          <Link to="/places/barbershop">이발소</Link>Link>
                                                          <Link to="/places/club">클럽</Link>Link>
                                                          <Link to="/places/villa">풀빌라</Link>Link>
                                                          <Link to="/places/airbnb">에어비앤비</Link>Link>
          ...
          {showTgLogin && (
                  <div className="tg-login-modal" onClick={handleCloseModal}>
                            <div className="tg-login-box" onClick={e => e.stopPropagation()}>
                                        <h3 className="gold-text">텔레그램으로 로그인</h3>h3>
          ...
          {menuOpen && (
                  <nav className="nav-mobile">
                            ...
                            <Link to="/places/karaoke-korean" onClick={() => setMenuOpen(false)}>추천업소</Link>Link>
                  </nav>nav>
              )}
        </header>header>
      )
