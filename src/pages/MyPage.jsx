                                          ...
                                          <div className="profile-left">
                                            {user.telegram_photo
                                                      ...
                                                      <div className="profile-info">
                                                        ...
                                                        {user.telegram_username && <span className="profile-tg">@{user.telegram_username}</span>}
                                                        {user.status === 'banned' && (
                                    <span style={{ background:'#2a1010', color:'#ff4444', padding:'2px 8px', borderRadius:'4px', fontSize:'11px', marginTop:'4px', display:'inline-block' }}>🚫 차단된 계정</span>
                                                                    )}
                                                      </div>
                                          </div>
